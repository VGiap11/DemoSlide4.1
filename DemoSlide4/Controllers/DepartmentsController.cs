...
namespace DemoSlide4.Controllers
{
    public class DepartmentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,NameDep,DescriptionDep")] Departments departments)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NameDep,DescriptionDep")] Departments departments)
        {
